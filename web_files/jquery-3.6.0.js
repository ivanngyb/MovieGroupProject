...
( function ( global, factory ) {
    ...
    typeof window !== "undefined" ? window : this, function ( window, noGlobal ) {
        ...
        */
         ...
         *
            ...
            if (!support.attributes || !assert(
                ...
                addHandle(
                    "value", function ( elem, _name, isXML ) {
        ...
        */
            ...
            jQuery.extend(
                {
                    ...
                    when: function ( singleValue ) {
                        ...
                        if (remaining <= 1 ) {
                            adoptValue(
                                singleValue, primary.done(updateFunc(i)).resolve, primary.reject,
                                !remaining 
                            );
        ...
        jQuery.each(
            [ "height", "width" ], function ( _i, dimension ) {
        ...
        jQuery.each(
            [ "toggle", "show", "hide" ], function ( _i, name ) {
        ...
        boolHook = {
            ...
            jQuery.each(
                jQuery.expr.match.bool.source.match(/\w+/g), function ( _i, name ) {
        ...
        jQuery.parseXML = function ( data ) {
            ...
            if (!xml || parserErrorElem ) {
                jQuery.error(
                    ...
                    parserErrorElem ?
                    jQuery.map(
                        parserErrorElem.childNodes, function ( el ) {
                ...
                if (s.crossDomain || s.scriptAttrs ) {
                    ...
                    return {
                        send: function ( _, complete ) {
                            ...
                            .on(
                                "load error", callback = function ( evt ) {
                                    script.remove();
                                    callback = null;
                                    if (evt ) {
